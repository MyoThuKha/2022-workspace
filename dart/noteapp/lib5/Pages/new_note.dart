...
class _NewNoteState extends State<NewNote> {
  ...
  Future<void> updateData(
      int id, String title, String text, int colorValue) async {
    await NoteTemplate().update(id, title, text, colorValue);
  }
  ...
  Widget build(BuildContext context) {
    ...
    titleControl = TextEditingController(
        text: (isCreated || colorChange) ? titleControl.text : '');
    textControl = TextEditingController(
        text: (isCreated || colorChange) ? textControl.text : '');
    return Scaffold(
                          ...
                          Expanded(
                            ...
                            child: IconButton(
                              ...
                              onPressed: () {
                                ...
                                if (isCreated) {
                                  updateData(
                                      currId, titleLog, textLog, colorCode);
                                } else {
